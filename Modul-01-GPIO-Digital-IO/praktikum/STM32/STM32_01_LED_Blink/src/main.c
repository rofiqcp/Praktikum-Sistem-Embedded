/**
 * @file main.c
 * @brief STM32_01_LED_Blink - Simple LED Blink on PC13
 *
 * LED on PC13 (built-in Blue Pill LED, active-low)
 * Blinks with 500ms interval using HAL_Delay()
 * PC13 is active-LOW on Blue Pill: LOW = ON, HIGH = OFF
 *
 * Hardware: Built-in LED on Blue Pill (PC13)
 */
