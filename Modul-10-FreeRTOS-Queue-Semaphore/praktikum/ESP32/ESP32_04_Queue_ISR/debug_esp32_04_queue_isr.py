...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_04_Queue_ISR
 Modul 10 - ESP32_04_Queue_ISR
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_04_queue_isr.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_04_queue_isr.py /dev/ttyUSB0 115200
   python3 debug_esp32_04_queue_isr.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_04_Queue_ISR")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_04_Queue_ISR - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_04_Queue_ISR")
    print(f"============================================================")
