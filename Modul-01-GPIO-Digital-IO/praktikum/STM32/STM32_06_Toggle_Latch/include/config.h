/**
 * @file config.h
 * @brief Hardware configuration for STM32_06_Toggle_Latch
 *
 * Button on PB0, LED on PC13
 * Edge detection: toggle LED on falling edge (button press)
 * Prev state != Current state detection with debounce
