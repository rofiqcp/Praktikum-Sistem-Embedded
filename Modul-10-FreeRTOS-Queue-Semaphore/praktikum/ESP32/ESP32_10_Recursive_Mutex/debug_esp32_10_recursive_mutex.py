...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_10_Recursive_Mutex
 Modul 10 - ESP32_10_Recursive_Mutex
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_10_recursive_mutex.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_10_recursive_mutex.py /dev/ttyUSB0 115200
   python3 debug_esp32_10_recursive_mutex.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_10_Recursive_Mutex")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_10_Recursive_Mutex - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_10_Recursive_Mutex")
    print(f"============================================================")
