...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_05_Queue_Set
 Modul 10 - ESP32_05_Queue_Set
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_05_queue_set.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_05_queue_set.py /dev/ttyUSB0 115200
   python3 debug_esp32_05_queue_set.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_05_Queue_Set")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_05_Queue_Set - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_05_Queue_Set")
    print(f"============================================================")
