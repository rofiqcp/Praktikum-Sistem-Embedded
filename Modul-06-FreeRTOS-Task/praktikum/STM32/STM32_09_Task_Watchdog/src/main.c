...
/* =========================================================================
 * Konfigurasi System Clock multi-MCU (F1 & F4) dengan LSI untuk IWDG
 * ========================================================================= */
static void SystemClock_Config(void)
{
...
#if defined(STM32F103xB)
    /* STM32F1xx: HSE 8MHz -> PLL x9 = 72MHz, LSI ON */
    ...
    /* STM32F401CC: HSE 25MHz -> PLL (M=25, N=336, P=4) = 84MHz, LSI ON */
    RCC_OscInitStruct.OscillatorType = RCC_OSCILLATORTYPE_HSE
                                     | RCC_OSCILLATORTYPE_LSI;
    RCC_OscInitStruct.HSEState       = RCC_HSE_ON;
    RCC_OscInitStruct.LSIState       = RCC_LSI_ON;
    ...
    /* STM32F411CE: HSE 25MHz -> PLL (M=25, N=400, P=4) = 100MHz, LSI ON */
    RCC_OscInitStruct.OscillatorType = RCC_OSCILLATORTYPE_HSE
                                     | RCC_OSCILLATORTYPE_LSI;
    RCC_OscInitStruct.HSEState       = RCC_HSE_ON;
    RCC_OscInitStruct.LSIState       = RCC_LSI_ON;
