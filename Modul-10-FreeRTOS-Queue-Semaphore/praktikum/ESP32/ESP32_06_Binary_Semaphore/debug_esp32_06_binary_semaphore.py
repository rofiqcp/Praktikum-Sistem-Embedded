...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_06_Binary_Semaphore
 Modul 10 - ESP32_06_Binary_Semaphore
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_06_binary_semaphore.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_06_binary_semaphore.py /dev/ttyUSB0 115200
   python3 debug_esp32_06_binary_semaphore.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_06_Binary_Semaphore")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_06_Binary_Semaphore - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_06_Binary_Semaphore")
    print(f"============================================================")
