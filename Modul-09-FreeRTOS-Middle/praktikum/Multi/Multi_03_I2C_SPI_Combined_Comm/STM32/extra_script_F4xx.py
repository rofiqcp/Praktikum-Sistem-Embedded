...
if not FRAMEWORK_DIR:
    ...
    # Add project's include directory for FreeRTOSConfig.h
    project_include = os.path.join(env["PROJECT_DIR"], "include")
    if os.path.exists(project_include):
        framework_includes.append(project_include)
        print("Added project include path: " + project_include)

    print("CPPPATH: " + str(framework_includes))
