...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_02_Queue_Struct
 Modul 10 - ESP32_02_Queue_Struct
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_02_queue_struct.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_02_queue_struct.py /dev/ttyUSB0 115200
   python3 debug_esp32_02_queue_struct.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_02_Queue_Struct")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_02_Queue_Struct - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_02_Queue_Struct")
    print(f"============================================================")
