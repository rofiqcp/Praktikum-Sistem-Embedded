...
- Grid preview program:
  * P01 LED Parade (Output Push-Pull)      * P06 Force Field (Pull-DOWN Internal)
  * P02 Shadow & Ghost (Active-LOW/OD)     * P07 Clean Contact (Debounce SM)
  * P03 Sentinel Gate (Pull-UP Ext)        * P08 Speed Racer (GPIO Slew Rate)
  * P04 Ground Guardian (Pull-DOWN Ext)    * P09 Twist & Count (Encoder 5-pin)
  * P05 Phantom Touch (Pull-UP Internal)   * P10 Matrix Commander (Keypad 4×4)
