...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_09_Mutex_Priority_Inversion
 Modul 10 - ESP32_09_Mutex_Priority_Inversion
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_09_mutex_priority_inversion.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_09_mutex_priority_inversion.py /dev/ttyUSB0 115200
   python3 debug_esp32_09_mutex_priority_inversion.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_09_Mutex_Priority_Inversion")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_09_Mutex_Priority_Inversion - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_09_Mutex_Priority_Inversion")
    print(f"============================================================")
