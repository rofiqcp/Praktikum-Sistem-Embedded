...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_12_Reader_Writer
 Modul 10 - ESP32_12_Reader_Writer
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_12_reader_writer.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_12_reader_writer.py /dev/ttyUSB0 115200
   python3 debug_esp32_12_reader_writer.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_12_Reader_Writer")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_12_Reader_Writer - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_12_Reader_Writer")
    print(f"============================================================")
