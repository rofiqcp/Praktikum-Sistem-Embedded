...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_01_Queue_Basic
 Modul 10 - ESP32_01_Queue_Basic
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_01_queue_basic.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_01_queue_basic.py /dev/ttyUSB0 115200
   python3 debug_esp32_01_queue_basic.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_01_Queue_Basic")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_01_Queue_Basic - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_01_Queue_Basic")
    print(f"============================================================")
