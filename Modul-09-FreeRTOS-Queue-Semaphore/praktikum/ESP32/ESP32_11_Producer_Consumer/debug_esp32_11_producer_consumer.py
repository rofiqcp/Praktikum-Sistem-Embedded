...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_11_Producer_Consumer
 Modul 10 - ESP32_11_Producer_Consumer
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_11_producer_consumer.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_11_producer_consumer.py /dev/ttyUSB0 115200
   python3 debug_esp32_11_producer_consumer.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_11_Producer_Consumer")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_11_Producer_Consumer - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_11_Producer_Consumer")
    print(f"============================================================")
