/**
 * @file main.c
 * @brief STM32_03_Timer_Periodic - TIM2 Periodic Interrupt Toggle LED
 *
 * TIM2 periodic interrupt every 1 second, toggle LED on PC13
 * Uses HAL_TIM_PeriodElapsedCallback for timer update event
 * F103: 72MHz timer clock, prescaler=7199, period=9999 -> 1s
 * F4xx: 84MHz timer clock, prescaler=8399, period=9999 -> 1s
 * PC13 is active-LOW on Blue Pill: LOW = ON, HIGH = OFF
 *
 * Hardware: Built-in LED on PC13
 */
...
/* ============================================================
 *  TIM2 Initialization - Periodic 1 second interrupt
 * ============================================================ */
void MX_TIM2_Init(void)
{
    /* Enable TIM2 clock */
