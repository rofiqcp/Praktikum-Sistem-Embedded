/**
 * @file config.h
 * @brief Hardware configuration for STM32_02_EXTI_Debounce
 *
 * External interrupt on PB0 (falling edge) with software debounce
 * ISR sets flag, main loop checks flag + time elapsed >= DEBOUNCE_MS
