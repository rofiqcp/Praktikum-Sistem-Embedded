...
"""
==========================================================
 DEBUG & ANALYSIS SCRIPT: ESP32_03_Queue_Multiple
 Modul 10 - ESP32_03_Queue_Multiple
==========================================================
 Tool untuk monitoring serial output dari ESP32/STM32,
 parsing data, dan analisa performa FreeRTOS.

 Penggunaan:
   python3 debug_esp32_03_queue_multiple.py [PORT] [BAUDRATE]
   
 Contoh:
   python3 debug_esp32_03_queue_multiple.py /dev/ttyUSB0 115200
   python3 debug_esp32_03_queue_multiple.py COM3 115200
==========================================================
"""
...
class SerialDebugger:
    ...
    def print_summary(self):
        ...
        print(f"\n============================================================")
        print(f"  CAPTURE SUMMARY - ESP32_03_Queue_Multiple")
        print(f"============================================================")
...
def main():
    ...
    print(f"\n============================================================")
    print(f"  ESP32_03_Queue_Multiple - Debug & Analysis Tool")
    print(f"  Modul 10 - ESP32_03_Queue_Multiple")
    print(f"============================================================")
